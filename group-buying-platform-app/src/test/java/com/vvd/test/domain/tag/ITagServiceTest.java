package com.vvd.test.domain.tag;

import com.vvd.domain.tag.service.impl.TagService;
...
public class ITagServiceTest {
    ...
    public void test_get_tag_bitmap() {
        ...
        // 是否存在
        log.info("vvd 存在，预期结果为 true，测试结果:{}", bitSet.get(redisService.getIndexFromUserId("vvd")));
